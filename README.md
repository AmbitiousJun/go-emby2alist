...
<div align="center">
  <a href="https://github.com/AmbitiousJun/go-emby2alist/tree/v1.4.1.1"><img src="https://img.shields.io/github/v/tag/AmbitiousJun/go-emby2alist"></img></a>
  <a href="https://hub.docker.com/r/ambitiousjun/go-emby2alist/tags"><img src="https://img.shields.io/docker/image-size/ambitiousjun/go-emby2alist/v1.4.1.1"></img></a>
...
```shell
git clone --branch v1.4.1.1 --depth 1 https://ghproxy.cc/https://github.com/AmbitiousJun/go-emby2alist
cd go-emby2alist
```
...
参考[示例配置](https://github.com/AmbitiousJun/go-emby2alist/blob/v1.4.1.1/config-example.yml)，配置好自己的服务器信息，保存并命名为 `config.yml`
...
services:
  go-emby2alist:
    image: ambitiousjun/go-emby2alist:v1.4.1.1
    environment:
      - TZ=Asia/Shanghai
      - GIN_MODE=release
